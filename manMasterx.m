...
%% Interactive mode: Calibrate image (do.calibrate)
...
if do.calibrate
    ...
    for i = 1:length(cList.vidType)
        ...
        currVidPath  = [paths.vid filesep cList.path{i} filesep 'scale' cList.ext{i}];
...
if do.bundleData
    ...
    for i = 1:length(cList.vidType)
        ...
        S = bundleData(iC,Centroid,Rotation,H,A,v);
